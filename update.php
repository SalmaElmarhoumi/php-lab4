e="text" id="email" name="email" value="<?php echo $userData['email']; ?>"><br>
        <p>Gender:</p>
...
<body>
    <form action="" method="post">
        ...
        <input typeckbox" id="subscribe" name="subscribe" value="yes" <?php echo $userData['subscribe'] == 'yes' ? 'checked' : ''; ?>>
